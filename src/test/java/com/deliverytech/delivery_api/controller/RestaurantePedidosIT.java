...
@ActiveProfiles("test")
class RestaurantePedidosIT extends BaseIntegrationTest {
  ...
  void shouldReturnPagedPedidosForRestaurante_whenExists() throws Exception {
    ...
    com.deliverytech.delivery_api.dto.request.ProdutoRequest pr =
        new com.deliverytech.delivery_api.dto.request.ProdutoRequest();
    ...
    com.deliverytech.delivery_api.dto.request.PedidoRequest pedido =
        new com.deliverytech.delivery_api.dto.request.PedidoRequest();
    pedido.setRestauranteId(saved.getId());
    pedido.setClienteId(1L);
    com.deliverytech.delivery_api.dto.request.EnderecoRequest endereco =
    ...
    com.deliverytech.delivery_api.dto.request.ItemPedidoRequest item =
        new com.deliverytech.delivery_api.dto.request.ItemPedidoRequest();
    ...
    mockMvc
        .perform(
            get("/api/restaurantes/{id}/pedidos", saved.getId())
  ...
  void shouldReturn404_whenRestauranteNotFound() throws Exception {
    mockMvc
        .perform(
            get("/api/restaurantes/{id}/pedidos", 9999999L).contentType(MediaType.APPLICATION_JSON))
