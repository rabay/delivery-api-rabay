...
class HealthControllerAppInfoTest {
    ...
    void deveCriarAppInfoComTodosCampos() {
        ...
        HealthController.AppInfo appInfo = new HealthController.AppInfo(
            application, version, developer, javaVersion, framework);
    ...
    void deveSerIgualQuandoCamposIguais() {
        // Given
        HealthController.AppInfo appInfo1 = new HealthController.AppInfo(
            "App", "1.0", "Dev", "JDK 21", "Spring Boot");
        HealthController.AppInfo appInfo2 = new HealthController.AppInfo(
            "App", "1.0", "Dev", "JDK 21", "Spring Boot");
    ...
    void deveSerDiferenteQuandoCamposDiferentes() {
        // Given
        HealthController.AppInfo appInfo1 = new HealthController.AppInfo(
            "App1", "1.0", "Dev", "JDK 21", "Spring Boot");
        HealthController.AppInfo appInfo2 = new HealthController.AppInfo(
            "App2", "1.0", "Dev", "JDK 21", "Spring Boot");
    ...
    void deveGerarToStringCorretamente() {
        // Given
        HealthController.AppInfo appInfo = new HealthController.AppInfo(
            "TestApp", "1.0", "TestDev", "JDK 21", "Spring Boot");
