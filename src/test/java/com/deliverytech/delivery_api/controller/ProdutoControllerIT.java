...
class ProdutoControllerIT extends BaseIntegrationTest {
  ...
  void shouldListProdutosPaged_andReturnPagedItems() throws Exception {
    ...
    p1.setNome("Produto List 1");
    p1.setCategoria("Pizza");
    p1.setDescricao("Esta é uma descrição válida com pelo menos 10 caracteres");
    ...
    p2.setNome("Produto List 2");
    p2.setCategoria("Bebida");
    p2.setDescricao("Esta é uma descrição válida com pelo menos 10 caracteres");
    p2.setPreco(BigDecimal.valueOf(5.00));
    p2.setRestaurante(r);
    p2.setQuantidadeEstoque(3);
    produtoService.cadastrar(p2);

    mockMvc
        .perform(get("/api/produtos?page=0&size=10").contentType(MediaType.APPLICATION_JSON))
  ...
  void shouldUpdateProduto_andReturnUpdated() throws Exception {
    ...
    p.setDescricao("Esta é uma descrição válida com pelo menos 10 caracteres");
    p.setPreco(BigDecimal.valueOf(5));
    p.setRestaurante(r);
    p.setQuantidadeEstoque(8);
    ...
    mockMvc
        .perform(
            put("/api/produtos/{id}", saved.getId())
                .contentType(MediaType.APPLICATION_JSON)
  ...
  void shouldPatchDisponibilidade_andReturnOk() throws Exception {
    ...
    Produto p = new Produto();
    p.setNome("P Patch");
    p.setCategoria("Sobremesa");
    p.setDescricao("Esta é uma descrição válida com pelo menos 10 caracteres");
    p.setPreco(BigDecimal.valueOf(3));
    p.setRestaurante(r);
    p.setQuantidadeEstoque(6);
    Produto saved = produtoService.cadastrar(p);
    ...
    mockMvc
        .perform(
            patch("/api/produtos/{id}/disponibilidade", saved.getId())
                .contentType(MediaType.APPLICATION_JSON)
  ...
  void shouldDeleteProduto_andReturnOk() throws Exception {
    ...
    p.setDescricao("Esta é uma descrição válida com pelo menos 10 caracteres");
    p.setPreco(BigDecimal.valueOf(4));
    p.setRestaurante(r);
    ...
    mockMvc
        .perform(
            delete("/api/produtos/{id}", saved.getId()).contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
  ...
  void shouldListProdutosPaged_andReturnCorrectPage() throws Exception {
    ...
    for (int i = 0; i < 6; i++) {
      ...
      p.setCategoria("Pizza");
      p.setDescricao("Esta é uma descrição válida com pelo menos 10 caracteres");
      p.setPreco(BigDecimal.valueOf(1 + i));
      p.setRestaurante(r);
    ...
    mockMvc
        .perform(get("/api/produtos?page=1&size=3").contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
  ...
  void shouldGetProdutoById_andReturnProduto() throws Exception {
    ...
    Produto p = new Produto();
    p.setNome("Produto Get");
    p.setCategoria("Bebida");
    p.setDescricao("Esta é uma descrição válida com pelo menos 10 caracteres");
    p.setPreco(BigDecimal.valueOf(5.50));
    p.setRestaurante(r);
    p.setQuantidadeEstoque(10);
    Produto saved = produtoService.cadastrar(p);

    mockMvc
        .perform(get("/api/produtos/{id}", saved.getId()).contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
  ...
  void shouldSearchProdutosByNome_andReturnFilteredResults() throws Exception {
    ...
    Produto p1 = new Produto();
    p1.setNome("Pizza Margherita Special");
    p1.setCategoria("Pizza");
    p1.setDescricao("Esta é uma descrição válida com pelo menos 10 caracteres");
    p1.setPreco(BigDecimal.valueOf(25.00));
    p1.setRestaurante(r);
    p1.setQuantidadeEstoque(5);
    produtoService.cadastrar(p1);

    Produto p2 = new Produto();
    p2.setNome("Pizza Calabresa Special");
    p2.setCategoria("Pizza");
    p2.setDescricao("Esta é uma descrição válida com pelo menos 10 caracteres");
    p2.setPreco(BigDecimal.valueOf(28.00));
    p2.setRestaurante(r);
    p2.setQuantidadeEstoque(3);
    produtoService.cadastrar(p2);

    Produto p3 = new Produto();
    p3.setNome("Refrigerante Cola Special");
    p3.setCategoria("Bebida");
    p3.setDescricao("Esta é uma descrição válida com pelo menos 10 caracteres");
    p3.setPreco(BigDecimal.valueOf(5.00));
    p3.setRestaurante(r);
  ...
  void shouldSearchProdutosByCategoria_andReturnFilteredResults() throws Exception {
    ...
    p1.setDescricao("Esta é uma descrição válida com pelo menos 10 caracteres");
    p1.setPreco(BigDecimal.valueOf(5.00));
    p1.setRestaurante(r);
    p1.setQuantidadeEstoque(10);
    produtoService.cadastrar(p1);

    Produto p2 = new Produto();
    p2.setNome("Fanta Laranja");
    p2.setCategoria("Bebida");
    p2.setDescricao("Esta é uma descrição válida com pelo menos 10 caracteres");
    p2.setPreco(BigDecimal.valueOf(4.50));
    p2.setRestaurante(r);
    p2.setQuantidadeEstoque(8);
    produtoService.cadastrar(p2);

    Produto p3 = new Produto();
    p3.setNome("Pizza Margherita");
    p3.setCategoria("Pizza");
    p3.setDescricao("Esta é uma descrição válida com pelo menos 10 caracteres");
    p3.setPreco(BigDecimal.valueOf(25.00));
    p3.setRestaurante(r);
    p3.setQuantidadeEstoque(5);
    produtoService.cadastrar(p3);

    mockMvc
        .perform(
            get("/api/produtos/categoria/{categoria}", "Bebida")
                .param("page", "0")
                .param("size", "10")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
  ...
  void shouldSearchProdutosByCategoria_whenNoResults_andReturnEmpty() throws Exception {
    mockMvc
        .perform(
            get("/api/produtos/categoria/{categoria}", "CategoriaInexistente")
                .param("page", "0")
                .param("size", "10")
                .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isOk())
