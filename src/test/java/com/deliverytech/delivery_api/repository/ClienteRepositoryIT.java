...
class ClienteRepositoryTest extends BaseIntegrationTest {
  ...
  void testRankingClientesPorPedidos() {
    ...
    com.deliverytech.delivery_api.model.Restaurante restaurante =
        new com.deliverytech.delivery_api.model.Restaurante();
    ...
    // Create product
    com.deliverytech.delivery_api.model.Produto produto =
    ...
    for (int i = 0; i < 5; i++) {
      com.deliverytech.delivery_api.model.Pedido pedido =
          new com.deliverytech.delivery_api.model.Pedido();
    ...
    List<RelatorioVendasClientes> ranking =
        clienteRepository.rankingClientesPorPedidos(inicio, fim, pageable);
    ...
    assertThat(ranking.get(0).getQuantidadePedidos())
        .isGreaterThan(ranking.get(1).getQuantidadePedidos());
  }
}
