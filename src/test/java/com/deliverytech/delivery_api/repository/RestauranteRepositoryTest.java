...
class RestauranteRepositoryTest extends BaseRepositoryTest {
  ...
  void testFindByNomeContainingIgnoreCase() {
    ...
    List<Restaurante> results =
        restauranteRepository.findByNomeContainingIgnoreCaseAndExcluidoFalse("pizza");
  ...
  void testFindByCategoria() {
    ...
    restauranteRepository.save(r);
    assertThat(restauranteRepository.findByCategoriaAndExcluidoFalse("Japonesa"))
  ...
  void testFindByTaxaEntregaLessThanEqual() {
    ...
    List<Restaurante> resultados =
        restauranteRepository.findByTaxaEntregaLessThanEqualAndExcluidoFalse(
