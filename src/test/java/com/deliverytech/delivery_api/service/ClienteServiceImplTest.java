...
class ClienteServiceImplTest {
    ...
    class BuscarPorIdTests {
        ...
        void deveLancarExcecaoQuandoClienteEstaExcluido() {
            // Arrange
            Cliente clienteExcluido = Cliente.builder()
                    .id(1L)
                    .excluido(true)
                    .build();
    ...
    class ListarAtivosTests {
        ...
        void deveRetornarPaginaDeClientesAtivos() {
            ...
            Page<ClienteResponse> expectedPage = new PageImpl<>(Arrays.asList(clienteResponse), pageable, 1);
    ...
    class BuscarPorNomeTests {
        ...
        void deveRetornarClientesQueContenhamNomePesquisado() {
            ...
            assertThat(response).extracting("nome")
    ...
    class InativarClienteTests {
        ...
        void naoDeveAlterarClienteJaInativo() {
            // Arrange
            Cliente clienteInativo = Cliente.builder()
                    .id(1L)
                    .ativo(false)
                    .excluido(true)
                    .build();
    ...
    class AtivarDesativarClienteTests {
        ...
        void deveAtivarClienteInativo() {
            ...
            Cliente clienteAtivado = Cliente.builder()
                    .id(1L)
                    .nome("João Silva")
                    .email("joao@email.com")
                    .ativo(true)
        ...
        void deveDesativarClienteAtivo() {
            // Arrange
            Cliente clienteDesativado = Cliente.builder()
                    .id(1L)
                    .nome("João Silva")
                    .email("joao@email.com")
                    .ativo(false)
