...
public class ProdutoServiceImplTest {
  ...
  public void testValidarEstoque_WithZeroStock_ShouldThrowProdutoIndisponivelException() {
    ...
    assertThrows(
        ProdutoIndisponivelException.class, () -> produtoService.validarEstoque(produto, 1));
  }
  ...
  public void testValidarEstoque_WithInsufficientStock_ShouldThrowEstoqueInsuficienteException() {
    ...
    EstoqueInsuficienteException exception =
        assertThrows(
            EstoqueInsuficienteException.class, () -> produtoService.validarEstoque(produto, 10));
  ...
  public void testValidarEstoque_WithNotAvailableProduct_ShouldThrowProdutoIndisponivelException() {
    ...
    assertThrows(
        ProdutoIndisponivelException.class, () -> produtoService.validarEstoque(produto, 5));
  }
