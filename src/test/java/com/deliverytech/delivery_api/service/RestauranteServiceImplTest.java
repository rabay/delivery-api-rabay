...
class RestauranteServiceImplTest {
    ...
    class BuscarPorIdTests {
        ...
        void deveLancarExcecaoQuandoRestauranteExcluido() {
            // Arrange
            Restaurante restauranteExcluido = Restaurante.builder()
                    .id(1L)
                    .excluido(true)
                    .build();
    ...
    class ListarRestaurantesTests {
        ...
        void deveRetornarPaginaDeRestaurantesAtivos() {
            ...
            when(restauranteRepository.findByAtivoTrueAndExcluidoFalse(pageable)).thenReturn(restaurantePage);
    ...
    class BuscarPorCategoriaTests {
        ...
        void deveRetornarRestaurantesPorCategoria() {
            ...
            when(restauranteRepository.findByCategoriaAndExcluidoFalse("Italiana")).thenReturn(restaurantesCategoria);
        ...
        void deveRetornarRestaurantesPorCategoriaComDto() {
            ...
            // Act
            List<RestauranteResponse> response = restauranteService.buscarRestaurantesPorCategoria("Italiana");
        ...
        void deveRetornarPaginaDeRestaurantesPorCategoria() {
            ...
            // Act
            Page<RestauranteResponse> response = restauranteService.buscarRestaurantesPorCategoria("Italiana", pageable);
    ...
    class CalcularTaxaEntregaTests {
        ...
        void deveUsarZeroQuandoTaxaEntregaNula() {
            // Arrange
            Restaurante restauranteSemTaxa = Restaurante.builder()
                    .id(1L)
                    .ativo(true)
                    .taxaEntrega(null)
                    .build();
    ...
    class BuscarProximosTests {
        ...
        void deveFiltrarRestaurantesComTaxaBaixaParaRegioes6Mais() {
            // Arrange
            Restaurante restauranteCaro = Restaurante.builder()
                    .id(2L)
    ...
    class AtualizarRestauranteTests {
        ...
        void deveAtualizarRestauranteComDto() {
            ...
            RestauranteResponse responseEsperado = RestauranteResponse.builder()
                    .id(1L)
                    .nome("Restaurante Atualizado")
                    .categoria("Japonesa")
                    .ativo(true)
