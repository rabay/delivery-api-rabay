...
class PagedResponseTest {
    ...
    void deveCriarPagedResponseComDadosCompletos() {
        ...
        Map<String, String> links = Map.of(
            "first", "/api/items?page=0",
            "last", "/api/items?page=9",
            "next", "/api/items?page=1"
        );
        ...
        PagedResponse<String> response = new PagedResponse<>(
            items, totalItems, page, size, totalPages, links, message, success);
    ...
    void deveCriarPagedResponseComDadosCliente() {
        ...
        // When
        PagedResponse<ClienteResponse> response = new PagedResponse<>(
            items, totalItems, page, size, totalPages, links, message, success);
    ...
    void deveCriarPagedResponseComPaginaIntermediaria() {
        ...
        // When
        PagedResponse<String> response = new PagedResponse<>(
            items, totalItems, page, size, totalPages, Map.of(), "Página 2", true);
    ...
    void deveCriarPagedResponseComStatusErro() {
        ...
        // When
        PagedResponse<String> response = new PagedResponse<>(
            items, 0, 0, 10, 0, Map.of(), message, success);
    ...
    void deveVerificarIgualdadeEntrePagedResponses() {
        ...
        PagedResponse<String> response1 = new PagedResponse<>(
            items, 10, 0, 5, 2, links, "OK", true);
        PagedResponse<String> response2 = new PagedResponse<>(
            items, 10, 0, 5, 2, links, "OK", true);
        PagedResponse<String> response3 = new PagedResponse<>(
            List.of("C", "D"), 10, 0, 5, 2, links, "OK", true);
    ...
    void deveGerarToStringLegivel() {
        ...
        PagedResponse<String> response = new PagedResponse<>(
            items, 1, 0, 10, 1, Map.of("first", "/test"), "Sucesso", true);
