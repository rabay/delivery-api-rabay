...
class ApiResultMapPagedTest {
    ...
    void deveDefinirEObterDadosMapasPaginados() {
        ...
        Map<String, String> links = Map.of(
            "first", "/api/generic?page=0",
            "last", "/api/generic?page=3"
        );

        PagedResponse<Map<String, Object>> pagedData = new PagedResponse<>(
            items, 67, 0, 10, 7, links, "Dados genéricos", true);
    ...
    void deveCriarApiResultMapPagedComMapaSimples() {
        ...
        PagedResponse<Map<String, Object>> pagedData = new PagedResponse<>(
            items, 1, 0, 10, 1, Map.of(), "Mapa simples", true);
    ...
    void deveCriarApiResultMapPagedComMapaComplexo() {
        ...
        PagedResponse<Map<String, Object>> pagedData = new PagedResponse<>(
            items, 1, 0, 10, 1, Map.of(), "Mapa complexo", true);
    ...
    void deveCriarApiResultMapPagedComMapaVazio() {
        ...
        PagedResponse<Map<String, Object>> pagedData = new PagedResponse<>(
            items, 1, 0, 10, 1, Map.of(), "Mapa vazio", true);
    ...
    void deveCriarApiResultMapPagedComMultiplosTiposDados() {
        ...
        Map<String, String> links = Map.of(
            "first", "/api/mixed?page=0",
            "prev", "/api/mixed?page=1",
            "self", "/api/mixed?page=2",
            "next", "/api/mixed?page=3",
            "last", "/api/mixed?page=4"
        );

        PagedResponse<Map<String, Object>> pagedData = new PagedResponse<>(
            items, 100, 2, 10, 10, links, "Dados mistos na página 3", true);
