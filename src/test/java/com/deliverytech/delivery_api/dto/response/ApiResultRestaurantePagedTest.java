...
class ApiResultRestaurantePagedTest {
    ...
    void deveDefinirEObterDadosRestaurantesPaginados() {
        ...
        Map<String, String> links = Map.of(
            "first", "/api/restaurantes?page=0",
            "last", "/api/restaurantes?page=3"
        );

        PagedResponse<RestauranteResponse> pagedData = new PagedResponse<>(
            items, 35, 0, 10, 4, links, "Restaurantes retornados", true);
    ...
    void deveCriarApiResultRestaurantePagedComDadosVazios() {
        ...
        PagedResponse<RestauranteResponse> pagedData = new PagedResponse<>(
            items, 0, 0, 10, 0, links, "Nenhum restaurante encontrado", true);
    ...
    void deveCriarApiResultRestaurantePagedComRestaurantesInativos() {
        ...
        PagedResponse<RestauranteResponse> pagedData = new PagedResponse<>(
            items, 1, 0, 10, 1, Map.of(), "Restaurante encontrado", true);
