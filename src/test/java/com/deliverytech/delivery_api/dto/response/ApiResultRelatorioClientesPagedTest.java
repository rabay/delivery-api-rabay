...
class ApiResultRelatorioClientesPagedTest {
  ...
  static class MockRelatorioVendasClientes
      implements com.deliverytech.delivery_api.projection.RelatorioVendasClientes {
    private final Long idCliente;
    private final String nomeCliente;
    private final BigDecimal totalCompras;
    private final Long quantidadePedidos;

    public MockRelatorioVendasClientes(
        Long idCliente, String nomeCliente, BigDecimal totalCompras, Long quantidadePedidos) {
  ...
  void deveDefinirEObterDadosRelatorioClientesPaginado() {
    // Given
    MockRelatorioVendasClientes cliente1 =
        new MockRelatorioVendasClientes(1L, "João Silva", new BigDecimal("450.75"), 5L);
    MockRelatorioVendasClientes cliente2 =
        new MockRelatorioVendasClientes(2L, "Maria Santos", new BigDecimal("320.50"), 3L);

    List<com.deliverytech.delivery_api.projection.RelatorioVendasClientes> items =
        List.of(cliente1, cliente2);
    Map<String, String> links =
        Map.of(
            "first", "/api/relatorios/clientes?page=0", "last", "/api/relatorios/clientes?page=3");

    PagedResponse<com.deliverytech.delivery_api.projection.RelatorioVendasClientes> pagedData =
        new PagedResponse<>(items, 67, 0, 10, 7, links, "Relatório de clientes", true);
  ...
  void deveCriarApiResultRelatorioClientesPagedComDadosVazios() {
    ...
    PagedResponse<com.deliverytech.delivery_api.projection.RelatorioVendasClientes> pagedData =
        new PagedResponse<>(items, 0, 0, 10, 0, links, "Nenhum cliente encontrado", true);
  ...
  void deveCriarApiResultRelatorioClientesPagedComClienteAltoValor() {
    // Given
    MockRelatorioVendasClientes cliente =
        new MockRelatorioVendasClientes(100L, "Cliente VIP", new BigDecimal("9999.99"), 50L);

    List<com.deliverytech.delivery_api.projection.RelatorioVendasClientes> items = List.of(cliente);
    PagedResponse<com.deliverytech.delivery_api.projection.RelatorioVendasClientes> pagedData =
        new PagedResponse<>(items, 1, 0, 10, 1, Map.of(), "Cliente VIP encontrado", true);
  ...
  void deveCriarApiResultRelatorioClientesPagedComClienteSemCompras() {
    // Given
    MockRelatorioVendasClientes cliente =
        new MockRelatorioVendasClientes(200L, "Cliente Novo", BigDecimal.ZERO, 0L);

    List<com.deliverytech.delivery_api.projection.RelatorioVendasClientes> items = List.of(cliente);
    PagedResponse<com.deliverytech.delivery_api.projection.RelatorioVendasClientes> pagedData =
        new PagedResponse<>(items, 1, 0, 10, 1, Map.of(), "Cliente sem compras", true);
  ...
  void deveCriarApiResultRelatorioClientesPagedComClienteFrequente() {
    // Given
    MockRelatorioVendasClientes cliente =
        new MockRelatorioVendasClientes(300L, "Cliente Frequente", new BigDecimal("1500.00"), 100L);
    ...
    Map<String, String> links =
        Map.of(
            ...
            "prev",
            "/api/relatorios/clientes?page=1",
            "self",
            "/api/relatorios/clientes?page=2",
            "next",
            "/api/relatorios/clientes?page=3",
            "last",
            "/api/relatorios/clientes?page=9");

    PagedResponse<com.deliverytech.delivery_api.projection.RelatorioVendasClientes> pagedData =
        new PagedResponse<>(items, 500, 2, 10, 50, links, "Cliente frequente na página 3", true);
