...
class ApiResultRelatorioProdutosPagedTest {
    ...
    static class MockRelatorioVendasProdutos implements com.deliverytech.delivery_api.projection.RelatorioVendasProdutos {
        private final Long idProduto;
        private final String nomeProduto;
        private final BigDecimal totalVendas;
        private final Long quantidadeItemPedido;

        public MockRelatorioVendasProdutos(Long idProduto, String nomeProduto, BigDecimal totalVendas, Long quantidadeItemPedido) {
    ...
    void deveDefinirEObterDadosRelatorioProdutosPaginado() {
        // Given
        MockRelatorioVendasProdutos produto1 = new MockRelatorioVendasProdutos(
            1L, "Pizza Margherita", new BigDecimal("299.00"), 10L);
        MockRelatorioVendasProdutos produto2 = new MockRelatorioVendasProdutos(
            2L, "Refrigerante Cola", new BigDecimal("45.00"), 15L);

        List<com.deliverytech.delivery_api.projection.RelatorioVendasProdutos> items = List.of(produto1, produto2);
        Map<String, String> links = Map.of(
            "first", "/api/relatorios/produtos?page=0",
            "last", "/api/relatorios/produtos?page=4"
        );

        PagedResponse<com.deliverytech.delivery_api.projection.RelatorioVendasProdutos> pagedData = new PagedResponse<>(
            items, 89, 0, 10, 9, links, "Relatório de produtos", true);
    ...
    void deveCriarApiResultRelatorioProdutosPagedComProdutoMaisVendido() {
        // Given
        MockRelatorioVendasProdutos produto = new MockRelatorioVendasProdutos(
        ...
        PagedResponse<com.deliverytech.delivery_api.projection.RelatorioVendasProdutos> pagedData = new PagedResponse<>(
            items, 1, 0, 10, 1, Map.of(), "Produto mais vendido", true);
    ...
    void deveCriarApiResultRelatorioProdutosPagedComProdutoSemVendas() {
        // Given
        MockRelatorioVendasProdutos produto = new MockRelatorioVendasProdutos(
            200L, "Produto Novo", BigDecimal.ZERO, 0L);

        List<com.deliverytech.delivery_api.projection.RelatorioVendasProdutos> items = List.of(produto);
        PagedResponse<com.deliverytech.delivery_api.projection.RelatorioVendasProdutos> pagedData = new PagedResponse<>(
            items, 1, 0, 10, 1, Map.of(), "Produto sem vendas", true);
    ...
    void deveCriarApiResultRelatorioProdutosPagedComProdutoAltoVolume() {
        // Given
        MockRelatorioVendasProdutos produto = new MockRelatorioVendasProdutos(
            300L, "Produto Popular", new BigDecimal("2500.00"), 500L);

        List<com.deliverytech.delivery_api.projection.RelatorioVendasProdutos> items = List.of(produto);
        Map<String, String> links = Map.of(
            "first", "/api/relatorios/produtos?page=0",
            "prev", "/api/relatorios/produtos?page=4",
            "self", "/api/relatorios/produtos?page=5",
            "next", "/api/relatorios/produtos?page=6",
            "last", "/api/relatorios/produtos?page=9"
        );

        PagedResponse<com.deliverytech.delivery_api.projection.RelatorioVendasProdutos> pagedData = new PagedResponse<>(
            items, 1000, 5, 10, 100, links, "Produto popular na página 6", true);
