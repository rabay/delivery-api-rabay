...
class ApiResultPedidoResumoPagedTest {
  ...
  void deveDefinirEObterDadosPedidosResumoPaginados() {
    ...
    Map<String, String> links =
        Map.of("first", "/api/pedidos/resumo?page=0", "last", "/api/pedidos/resumo?page=5");

    PagedResponse<PedidoResumoResponse> pagedData =
        new PagedResponse<>(items, 67, 0, 10, 7, links, "Resumo de pedidos", true);
  ...
  void deveCriarApiResultPedidoResumoPagedComPedidoCancelado() {
    ...
    PagedResponse<PedidoResumoResponse> pagedData =
        new PagedResponse<>(items, 1, 0, 10, 1, Map.of(), "Pedido cancelado", true);
  ...
  void deveCriarApiResultPedidoResumoPagedComPedidoFinalizado() {
    ...
    List<PedidoResumoResponse> items = List.of(pedido);
    PagedResponse<PedidoResumoResponse> pagedData =
        new PagedResponse<>(items, 1, 0, 10, 1, Map.of(), "Pedido finalizado", true);
  ...
  void deveCriarApiResultPedidoResumoPagedComPedidoAltoValor() {
    ...
    List<PedidoResumoResponse> items = List.of(pedido);
    PagedResponse<PedidoResumoResponse> pagedData =
        new PagedResponse<>(items, 1, 0, 10, 1, Map.of(), "Pedido de alto valor", true);
  ...
  void deveCriarApiResultPedidoResumoPagedComPedidoRecente() {
    ...
    List<PedidoResumoResponse> items = List.of(pedido);
    PagedResponse<PedidoResumoResponse> pagedData =
        new PagedResponse<>(items, 1, 0, 10, 1, Map.of(), "Pedido recente", true);
  ...
  void deveCriarApiResultPedidoResumoPagedComDescontoAplicado() {
    ...
    List<PedidoResumoResponse> items = List.of(pedido);
    PagedResponse<PedidoResumoResponse> pagedData =
        new PagedResponse<>(items, 1, 0, 10, 1, Map.of(), "Pedido com desconto", true);
