...
class ApiResultProdutoPagedTest {
  ...
  void deveDefinirEObterDadosProdutosPaginados() {
    ...
    Map<String, String> links =
        Map.of("first", "/api/produtos?page=0", "last", "/api/produtos?page=1");

    PagedResponse<ProdutoResponse> pagedData =
        new PagedResponse<>(items, 12, 0, 10, 2, links, "Produtos retornados", true);
  ...
  void deveCriarApiResultProdutoPagedComProdutosInativos() {
    ...
    PagedResponse<ProdutoResponse> pagedData =
        new PagedResponse<>(items, 1, 0, 10, 1, Map.of(), "Produto encontrado", true);
  ...
  void deveCriarApiResultProdutoPagedComProdutosPrecoZero() {
    ...
    List<ProdutoResponse> items = List.of(produto);
    PagedResponse<ProdutoResponse> pagedData =
        new PagedResponse<>(items, 1, 0, 10, 1, Map.of(), "Produto gratuito encontrado", true);
  ...
  void deveCriarApiResultProdutoPagedComProdutosAltoValor() {
    ...
    List<ProdutoResponse> items = List.of(produto);
    PagedResponse<ProdutoResponse> pagedData =
        new PagedResponse<>(items, 1, 0, 10, 1, Map.of(), "Produto premium encontrado", true);
