...
class ApiResultClientePagedTest {
  ...
  void deveDefinirEObterDadosPaginacao() {
    ...
    Map<String, String> links =
        Map.of("first", "/api/clientes?page=0", "last", "/api/clientes?page=2");

    PagedResponse<ClienteResponse> pagedData =
        new PagedResponse<>(items, 25, 0, 10, 3, links, "Página retornada", true);
  ...
  void deveCriarApiResultClientePagedComDadosPaginaEspecifica() {
    ...
    PagedResponse<ClienteResponse> pagedData =
        new PagedResponse<>(items, 50, 2, 10, 5, links, "Página 3 de 5", true);
  ...
  void deveCriarApiResultClientePagedComDadosClienteInativo() {
    ...
    List<ClienteResponse> items = List.of(cliente);
    PagedResponse<ClienteResponse> pagedData =
        new PagedResponse<>(items, 1, 0, 10, 1, Map.of(), "Cliente encontrado", true);
