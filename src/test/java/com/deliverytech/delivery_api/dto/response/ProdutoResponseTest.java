...
class ProdutoResponseTest {
  ...
  class GettersSettersTests {
    ...
    void devePermitirDefinirEObterRestaurante() {
      // Given
      ProdutoResponse produto = new ProdutoResponse();
      RestauranteResumoResponse expectedRestaurante =
          RestauranteResumoResponse.builder().id(1L).nome("Pizzaria Italiana").build();
  ...
  class BuilderPatternTests {
    ...
    void deveCriarProdutoUsandoBuilderPattern() {
      ...
      assertThat(produto.getDescricao())
          .isEqualTo("Pizza tradicional com molho de tomate, mussarela e manjericão");
  ...
  class SuccessScenariosTests {
    ...
    void deveCriarProdutoIndisponivel() {
      ...
      ProdutoResponse produto = new ProdutoResponse();
      RestauranteResumoResponse restaurante =
          RestauranteResumoResponse.builder().id(2L).nome("Restaurante Mexicano").build();
    ...
    void deveCriarProdutoSemEstoque() {
      ...
      ProdutoResponse produto = new ProdutoResponse();
      RestauranteResumoResponse restaurante =
          RestauranteResumoResponse.builder().id(3L).nome("Cafeteria Central").build();
    ...
    void deveCriarProdutoComPrecoZero() {
      ...
      ProdutoResponse produto = new ProdutoResponse();
      RestauranteResumoResponse restaurante =
          RestauranteResumoResponse.builder().id(4L).nome("Restaurante Popular").build();
    ...
    void deveCriarProdutoComValoresBigDecimal() {
      ...
      ProdutoResponse produto =
          ProdutoResponse.builder()
              ...
              .preco(preco)
              .restaurante(
                  RestauranteResumoResponse.builder().id(5L).nome("Restaurante Executivo").build())
              .disponivel(true)
              .quantidadeEstoque(5)
              .build();
      ...
      assertThat(produto.getDescricao())
          .isEqualTo("Prato completo com entrada, prato principal e sobremesa");
