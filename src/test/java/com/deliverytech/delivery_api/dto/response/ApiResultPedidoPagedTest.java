...
class ApiResultPedidoPagedTest {
    ...
    void deveDefinirEObterDadosPedidosPaginados() {
        ...
        Map<String, String> links = Map.of(
            "first", "/api/pedidos?page=0",
            "last", "/api/pedidos?page=5"
        );

        PagedResponse<PedidoResponse> pagedData = new PagedResponse<>(
            items, 67, 0, 10, 7, links, "Pedidos retornados", true);
    ...
    void deveCriarApiResultPedidoPagedComPedidosCancelados() {
        ...
        PagedResponse<PedidoResponse> pagedData = new PagedResponse<>(
            items, 1, 0, 10, 1, Map.of(), "Pedido cancelado encontrado", true);
    ...
    void deveCriarApiResultPedidoPagedComPedidosFinalizados() {
        ...
        List<PedidoResponse> items = List.of(pedido);
        PagedResponse<PedidoResponse> pagedData = new PagedResponse<>(
            items, 1, 0, 10, 1, Map.of(), "Pedido finalizado encontrado", true);
    ...
    void deveCriarApiResultPedidoPagedComPedidosAltoValor() {
        ...
        List<PedidoResponse> items = List.of(pedido);
        PagedResponse<PedidoResponse> pagedData = new PagedResponse<>(
            items, 1, 0, 10, 1, Map.of(), "Pedido de alto valor encontrado", true);
    ...
    void deveCriarApiResultPedidoPagedComPedidosRecentes() {
        ...
        List<PedidoResponse> items = List.of(pedido);
        PagedResponse<PedidoResponse> pagedData = new PagedResponse<>(
            items, 1, 0, 10, 1, Map.of(), "Pedido recente encontrado", true);
