...
class LoginRequestTest {
  ...
  class CenariosValidacao {
    ...
    void deveRejeitarUsernameNulo() {
      ...
      assertThat(violations.iterator().next().getMessage()).contains("Username é obrigatório");
    }
    ...
    void deveRejeitarPasswordNulo() {
      ...
      // Then
      assertThat(violations).hasSize(1);
      assertThat(violations.iterator().next().getMessage()).contains("Password é obrigatório");
    }
