...
class ProdutoTest {
  ...
  class ValidationTests {
    ...
    void shouldFailValidationWhenNomeIsNull() {
      ...
      assertTrue(
          violations.stream()
              .anyMatch(v -> v.getMessage().contains("Nome do produto é obrigatório")));
    }
    ...
    void shouldFailValidationWhenNomeIsTooLong() {
      ...
      assertTrue(
          violations.stream()
              .anyMatch(v -> v.getMessage().contains("Nome não pode ter mais de 100 caracteres")));
    }
    ...
    void shouldFailValidationWhenPrecoIsZero() {
      ...
      assertTrue(
          violations.stream()
              .anyMatch(v -> v.getMessage().contains("Preço deve ser maior que zero")));
    }
    ...
    void shouldFailValidationWhenRestauranteIsNull() {
      ...
      assertFalse(violations.isEmpty());
      assertTrue(
          violations.stream().anyMatch(v -> v.getMessage().contains("Restaurante é obrigatório")));
    }
    ...
    void shouldValidateCategoriaLength() {
      ...
      assertTrue(
          violations.stream()
              .anyMatch(
                  v -> v.getMessage().contains("Categoria não pode ter mais de 50 caracteres")));
    }
    ...
    void shouldValidateDescricaoLength() {
      ...
      assertTrue(
          violations.stream()
              .anyMatch(
                  v -> v.getMessage().contains("Descrição não pode ter mais de 500 caracteres")));
    }
  }
  ...
  class BusinessLogicTests {
    ...
    void shouldIdentifyInfiniteStockWhenQuantidadeEstoqueIsNegative() {
      // Given
      Produto produto = Produto.builder().quantidadeEstoque(-1).build();
    ...
    void shouldNotIdentifyInfiniteStockWhenQuantidadeEstoqueIsPositive() {
      // Given
      Produto produto = Produto.builder().quantidadeEstoque(10).build();
    ...
    void shouldNotIdentifyInfiniteStockWhenQuantidadeEstoqueIsZero() {
      // Given
      Produto produto = Produto.builder().quantidadeEstoque(0).build();
    ...
    void shouldBeDisponivelWhenDisponivelIsTrueAndHasStock() {
      // Given
      Produto produto = Produto.builder().disponivel(true).quantidadeEstoque(5).build();
    ...
    void shouldBeDisponivelWhenDisponivelIsTrueAndHasInfiniteStock() {
      // Given
      Produto produto = Produto.builder().disponivel(true).quantidadeEstoque(-1).build();
    ...
    void shouldNotBeDisponivelWhenDisponivelIsFalse() {
      // Given
      Produto produto = Produto.builder().disponivel(false).quantidadeEstoque(10).build();
    ...
    void shouldNotBeDisponivelWhenHasNoStock() {
      // Given
      Produto produto = Produto.builder().disponivel(true).quantidadeEstoque(0).build();
    ...
    void shouldIncreaseStockCorrectly() {
      // Given
      Produto produto = Produto.builder().quantidadeEstoque(5).build();
