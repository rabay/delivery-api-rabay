...
class UsuarioTest {
  ...
  class ConstructorAndBuilderTests {
    ...
    void shouldCreateUsuarioWithAllArgsConstructor() {
      ...
      // When
      Usuario usuario =
          new Usuario(id, nome, email, senha, role, ativo, dataCriacao, restauranteId);
  ...
  class UserDetailsImplementationTests {
    ...
    void shouldReturnSenhaAsPassword() {
      // Given
      Usuario usuario = Usuario.builder().senha("minhaSenha").build();
    ...
    void shouldReturnRoleAsSingleAuthority() {
      // Given
      Usuario usuario = Usuario.builder().role(Role.ADMIN).build();
  ...
  class EqualsAndHashCodeTests {
    ...
    void shouldBeEqualWhenBothHaveNullIdButSameOtherFields() {
      // Given
      Usuario usuario1 = Usuario.builder().id(null).nome("João").email("joao@email.com").build();
      Usuario usuario2 = Usuario.builder().id(null).nome("João").email("joao@email.com").build();
  ...
  class BusinessLogicTests {
    ...
    void shouldHandleRestauranteAssociationCorrectly() {
      ...
      Usuario usuarioCliente =
          Usuario.builder()
              .role(Role.CLIENTE)
              .restauranteId(null) // Cliente não tem
              // restaurante
              .build();
      ...
      Usuario usuarioRestaurante =
          Usuario.builder()
              .role(Role.RESTAURANTE)
              .restauranteId(10L) // Restaurante tem
              // ID associado
              .build();
    ...
    void shouldHandleDataCriacaoTimestamp() {
      ...
      Usuario usuario = Usuario.builder().dataCriacao(now).build();
