...
public class EnderecoRequest {
  ...
  @Schema(
      description = "Nome da rua/avenida do endereço. Máximo de 100 caracteres.",
  ...
  @Schema(
      description = "Número do endereço. Máximo de 10 caracteres.",
      example = "123",
      requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  @Schema(
      description = "Bairro do endereço. Máximo de 50 caracteres.",
      example = "Centro",
      requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  @Schema(
      description = "Cidade do endereço. Máximo de 50 caracteres.",
      example = "São Paulo",
      requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  @Schema(
      description = "Estado do endereço (sigla UF).",
      example = "SP",
      requiredMode = Schema.RequiredMode.REQUIRED)
