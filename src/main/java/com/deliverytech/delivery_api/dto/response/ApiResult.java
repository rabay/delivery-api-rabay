...
/**
 * Wrapper genérico para respostas de sucesso e erro.
 * Renomeado para evitar colisão com as anotações OpenAPI (@ApiResponse).
 */
@Schema(name = "ApiResult", description = "Envelope padrão das respostas da API",
