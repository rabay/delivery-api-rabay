 ...
 * ApiResult<PagedResponse<ProdutoResponse>>
 */
@Schema(
    description =
        "ApiResult contendo uma página de produtos com envelope { data, message, success }",
    example =
        "{\n"
            + "  \"data\": {\n"
            ...
            + "    \"totalItems\": 1,\n"
            + "    \"totalPages\": 1,\n"
            + "    \"links\": { \"first\": \"/api/produtos?page=0\", \"last\": \"/api/produtos?page=0\" }\n"
            + "  },\n"
