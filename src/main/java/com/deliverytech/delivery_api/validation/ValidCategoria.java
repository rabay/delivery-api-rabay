 ...
 *
 * <p>Aceita categorias predefinidas válidas: - Restaurantes: Brasileira, Italiana, Japonesa,
 * Chinesa, Americana, Mexicana, Indiana, Árabe, Francesa, etc. - Produtos: Pizza, Hambúrguer,
 * Sushi, Bebida, Sobremesa, Lanche, Prato Principal, Entrada, etc.
 *
 * <p>Exemplo de uso: @ValidCategoria(type = ValidCategoria.Type.RESTAURANTE) private String
 * categoria;
 */
@Documented
