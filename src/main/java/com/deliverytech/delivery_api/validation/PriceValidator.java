...
/**
 * Implementa a interface para validar a anotação @ValidPrice
 * Valida valores monetários (BigDecimal) para preços
 */
public class PriceValidator implements ConstraintValidator<ValidPrice, BigDecimal> {
     ...
     * 'value' é o valor do campo anotado com @ValidPrice
     */
    @Override
