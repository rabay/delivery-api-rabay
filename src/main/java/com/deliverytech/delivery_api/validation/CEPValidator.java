...
/**
 * Implementa a interface para validar a anotação @ValidCEP Valida strings que representam CEPs
 * (códigos postais)
 */
public class CEPValidator implements ConstraintValidator<ValidCEP, String> {

  /** Método que contém a regra de validação 'value' é o valor do campo anotado com @ValidCEP */
  @Override
