...
/**
 * Implementa a interface para validar a anotação @ValidPhone Valida strings que representam números
...
public class PhoneValidator implements ConstraintValidator<ValidPhone, String> {
  ...
  /** Método que contém a regra de validação 'value' é o valor do campo anotado com @ValidPhone */
  @Override
