...
/**
 * Implementa a interface para validar a anotação @ValidEstado
 * Valida strings que representam códigos de estado brasileiros (UF)
 */
public class EstadoValidator implements ConstraintValidator<ValidEstado, String> {
    ...
    private static final Set<String> VALID_ESTADOS = new HashSet<>(Arrays.asList(
        "AC", // Acre
        "AL", // Alagoas
        "AP", // Amapá
        "AM", // Amazonas
     ...
     * 'value' é o valor do campo anotado com @ValidEstado
     */
    @Override
