...
public interface ProdutoService {
  ...
  org.springframework.data.domain.Page<com.deliverytech.delivery_api.dto.response.ProdutoResponse>
  ...
  org.springframework.data.domain.Page<com.deliverytech.delivery_api.dto.response.ProdutoResponse>
      buscarProdutosPorNome(String nome, org.springframework.data.domain.Pageable pageable);

  // Versão paginada
  org.springframework.data.domain.Page<ProdutoResponse> buscarDisponiveis(
