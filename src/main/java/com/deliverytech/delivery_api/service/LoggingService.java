...
public class LoggingService {
    ...
    public void logRequestResponse(ContentCachingRequestWrapper request, 
    ...
    private String extractResponseData(ContentCachingResponseWrapper response) {
        ...
        response.getHeaderNames().forEach(headerName -> {
            responseData.append(headerName)
                .append(": ")
    ...
    private String formatLogEntry(String requestId, String method, String uri, 
                               int status, long duration, String requestData, String responseData) {
