...
public class DbController {
    ...
    public ResponseEntity<Map<String, Object>> integrity() {
        ...
        String insertSql = "INSERT INTO ITEM_PEDIDO (id, pedido_id, produto_id, quantidade, preco_unitario, subtotal) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public ResponseEntity<Map<String, Object>> query(@RequestBody Map<String, String> body) {
        ...
        if (upper.contains(";") || upper.contains("UPDATE") || upper.contains("DELETE") || upper.contains("INSERT") || upper.contains("ALTER") || upper.contains("DROP") || upper.contains("TRUNCATE")) {
