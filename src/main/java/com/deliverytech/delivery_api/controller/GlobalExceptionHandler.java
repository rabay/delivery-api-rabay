...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<com.deliverytech.delivery_api.dto.response.ApiResult<Object>>
      handleEmailDuplicado(EmailDuplicadoException ex) {
    var body =
        new com.deliverytech.delivery_api.dto.response.ApiResult<>(
            null, "Email duplicado: " + ex.getMessage(), false);
  ...
  public ResponseEntity<com.deliverytech.delivery_api.dto.response.ApiResult<Object>>
    ...
    var body =
        new com.deliverytech.delivery_api.dto.response.ApiResult<>(
            null, "Estoque insuficiente: " + ex.getMessage(), false);
    return ResponseEntity.status(HttpStatus.CONFLICT).body(body);
  }
  ...
  public ResponseEntity<com.deliverytech.delivery_api.dto.response.ApiResult<Object>>
    ...
    var body =
        new com.deliverytech.delivery_api.dto.response.ApiResult<>(
            null, "Produto indisponível: " + ex.getMessage(), false);
    return ResponseEntity.status(HttpStatus.CONFLICT).body(body);
  }
  ...
  public ResponseEntity<com.deliverytech.delivery_api.dto.response.ApiResult<Object>>
    ...
    var body =
        new com.deliverytech.delivery_api.dto.response.ApiResult<>(
            null, "Entidade não encontrada: " + ex.getMessage(), false);
  ...
  public ResponseEntity<com.deliverytech.delivery_api.dto.response.ApiResult<Object>>
    ...
    var body =
        new com.deliverytech.delivery_api.dto.response.ApiResult<>(
            null, "Erro de negócio: " + ex.getMessage(), false);
  ...
  public ResponseEntity<
    ...
    var body =
        new com.deliverytech.delivery_api.dto.response.ApiResult<>(
            errors, "Erro de validação", false);
  ...
  public ResponseEntity<com.deliverytech.delivery_api.dto.response.ApiResult<Object>>
    ...
    var body =
        new com.deliverytech.delivery_api.dto.response.ApiResult<>(
            null, "Erro de transação: " + ex.getMessage(), false);
