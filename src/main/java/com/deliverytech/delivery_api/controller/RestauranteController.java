...
public class RestauranteController {
    ...
    public RestauranteController(RestauranteService restauranteService, ProdutoService produtoService) {
    ...
    @Operation(summary = "Calcular taxa de entrega", description = "Calcula a taxa de entrega para um restaurante em um CEP específico.")
    @GetMapping("/{id}/taxa-entrega/{cep}")
    public ResponseEntity<Map<String, Object>> calcularTaxaEntrega(@PathVariable Long id, @PathVariable String cep) {
        try {
