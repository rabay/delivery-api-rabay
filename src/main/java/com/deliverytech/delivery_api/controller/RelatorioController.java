...
public class RelatorioController {
  ...
  public ResponseEntity<
    ...
    if (pageImpl.hasNext()) {
      links.put(
          "next",
          uriBuilder.replaceQueryParam("page", pageImpl.getNumber() + 1).build().toUriString());
    }
  ...
  public ResponseEntity<
    ...
    if (pageImpl.hasNext()) {
      links2.put(
          "next",
          uriBuilder2.replaceQueryParam("page", pageImpl.getNumber() + 1).build().toUriString());
    }
    if (pageImpl.hasPrevious()) {
      links2.put(
          "prev",
  ...
  public ResponseEntity<
    ...
    if (pageImpl.hasNext()) {
      links3.put(
          "next",
          uriBuilder3.replaceQueryParam("page", pageImpl.getNumber() + 1).build().toUriString());
    }
    if (pageImpl.hasPrevious()) {
      links3.put(
          "prev",
  ...
  public ResponseEntity<
    ...
    if (pageImpl.hasNext()) {
      links4.put(
          "next",
          uriBuilder4.replaceQueryParam("page", pageImpl.getNumber() + 1).build().toUriString());
    }
    if (pageImpl.hasPrevious()) {
      links4.put(
          "prev",
  ...
  public ResponseEntity<
    ...
    if (pageImpl.hasNext()) {
      links5.put(
          "next",
          uriBuilder5.replaceQueryParam("page", pageImpl.getNumber() + 1).build().toUriString());
    }
    if (pageImpl.hasPrevious()) {
      links5.put(
          "prev",
