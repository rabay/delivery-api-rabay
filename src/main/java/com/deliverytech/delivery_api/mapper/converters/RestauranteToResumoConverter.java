...
@Component
public class RestauranteToResumoConverter
    implements Converter<Restaurante, RestauranteResumoResponse> {

  @Override
  public RestauranteResumoResponse convert(
      MappingContext<Restaurante, RestauranteResumoResponse> context) {
