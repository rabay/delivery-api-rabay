...
public class ClienteTypeMap {
  ...
  public void configure() {
    ...
    TypeMap<Cliente, ClienteResponse> clienteToResponse =
        modelMapper.createTypeMap(Cliente.class, ClienteResponse.class);
    ...
    TypeMap<ClienteRequest, Cliente> requestToCliente =
        modelMapper.createTypeMap(ClienteRequest.class, Cliente.class);
