...
public class ProdutoTypeMap {
    ...
    public ProdutoTypeMap(ModelMapper modelMapper, RestauranteToResumoConverter restauranteConverter) {
    ...
    public void configure() {
        ...
        TypeMap<Produto, ProdutoResponse> produtoToResponse = modelMapper.createTypeMap(Produto.class, ProdutoResponse.class);
        ...
        produtoToResponse.addMapping(Produto::getQuantidadeEstoque, ProdutoResponse::setQuantidadeEstoque);
        
        // Add our custom mapping for restaurante using the converter
        produtoToResponse.addMapping(
            src -> src.getRestaurante(), 
            ProdutoResponse::setRestaurante
        );
        
        // ProdutoRequest to Produto mapping
        TypeMap<ProdutoRequest, Produto> requestToProduto = modelMapper.createTypeMap(ProdutoRequest.class, Produto.class);
        ...
        requestToProduto.addMapping(ProdutoRequest::getQuantidadeEstoque, Produto::setQuantidadeEstoque);
    }
}